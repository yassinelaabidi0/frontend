          ...
          <div className="relative flex flex-col">
            ...
            <div className="overflow-y-auto" style={{ maxHeight: '400px' }}>
              <Textarea
                ...
                disabled={disabled}
                className={cn(
                  'min-h-[72px] w-full resize-none rounded-xl rounded-b-none border-none bg-black/5 px-4 py-3 focus-visible:ring-0 focus-visible:ring-offset-0 dark:bg-white/5 dark:text-white dark:placeholder:text-white/70 placeholder:text-black/70',
                )}
                ref={textareaRef}
              ...
              <div className="absolute right-3 bottom-3 left-3 flex w-[calc(100%-24px)] items-center justify-between">
                <div className="flex items-center gap-2">
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent
                      className={cn(
                        'min-w-40 border-black/10 bg-gradient-to-b from-white via-white to-neutral-100 dark:border-white/10 dark:from-neutral-950 dark:via-neutral-900 dark:to-neutral-800',
                      )}
                    >
                      {AI_MODELS.map((model) => (
                        <DropdownMenuItem
                  ...
                  <label
                    className={cn(
                      'cursor-pointer rounded-lg bg-black/5 p-2 text-black/40 hover:bg-black/10 hover:text-black focus-visible:ring-1 focus-visible:ring-blue-500 focus-visible:ring-offset-0 dark:bg-white/5 dark:text-white/40 dark:hover:bg-white/10 dark:hover:text-white',
                    )}
